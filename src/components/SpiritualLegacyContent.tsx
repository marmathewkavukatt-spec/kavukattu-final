      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8 max-w-6xl mx-auto mb-12">
            ...
            <motion.div 
              variants={fadeInUp}
              className="bg-gradient-to-br from-stone-700/10 to-stone-700/5 border-l-4 border-stone-700 rounded-r-xl p-8 hover:shadow-lg transition-all duration-300"
            >
              <div className="w-10 h-10 rounded-full bg-stone-700 flex items-center justify-center mb-6">
                <span className="font-serif text-white font-bold text-sm">III</span>
              </div>
              <p className="text-lg leading-relaxed text-stone-700">
                {aChurchOfText} <span className="font-bold text-stone-800">{responsibilityText}</span>{whereFaithLeadsText}
              </p>
            </motion.div>
          </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-5xl mx-auto mb-12">
            ...
            <motion.div
              ...
              whileHover={{ scale: 1.05, y: -5 }}
              transition={{ duration: 0.3, ease: "easeOut" }}
              className="bg-white/5 border border-white/10 rounded-xl p-6 hover:bg-white/10 hover:border-white/20 hover:shadow-xl transition-all duration-300"
            >
