...
export default function HomeHistorySection() {
  ...
  return (
    <section id="history" className="relative bg-stone-50 scroll-mt-20 overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 z-10">
        ...
        <div className="text-center mb-12 relative z-20">
          <h2 className="site-page-title mb-6 text-white drop-shadow-md">{tr.history}</h2>
        ...
        <div className="mt-10 relative z-20">
          ...
          <div className="bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl p-6 sm:p-8 border border-white/20 relative z-20">
            <h3 className="site-section-title text-stone-900">{priestName}</h3>
            <p className="mt-4 site-body-text text-justify whitespace-pre-line text-stone-800">{description}</p>
          </div>
