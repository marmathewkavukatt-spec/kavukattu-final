...
const announcementSections = [
  ...
  { 
    ...
    desc: "Manage existing announcements",
...
export default function AnnouncementsPage() {
  return (
    <div>
      ...
      <h1 className="mt-4 font-serif text-[36px] sm:text-[40px] lg:text-[48px] font-semibold text-stone-800">Announcements</h1>
      <p className="mt-2 text-base text-stone-600">Choose an option to manage announcements.</p>
