...
export default function EditExperiencePage() {
    ...
    async function loadExperience() {
      try {
        ...
        if (res.ok) {
          ...
          setMessage({ text: "Failed to load experience.", type: "error" });
        }
      } catch (error) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setMessage({ text: "Failed to update experience. Please try again.", type: "error" });
      }
    } catch (error) {
  ...
  return (
    <div className="pb-8">
      <BackButton />
      <h1 className="mt-4 font-serif text-[36px] sm:text-[40px] lg:text-[48px] font-bold text-stone-800">Edit Experience</h1>
      <p className="mt-2 text-base text-stone-600">Update the experience testimony.</p>
